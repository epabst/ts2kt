...
package unionType.withNullOrUndefined
...
external var nullableFoo: String? = definedExternally
external var bar: String? = definedExternally
external fun bar(a: String?): FooWithNullable? = definedExternally
external fun baz(a: FooWithNullable?, b: Number? = definedExternally /* null */): Any? = definedExternally
...
external open class FooWithNullable(a: String?) {
    open fun someMethod(): dynamic /* String | Number | Nothing? */ = definedExternally
    open var foo: FooWithNullable? = definedExternally
